        ...
        <>
            <div className='section-center'>
                ...
                <div className="flex flex-col md:flex-row gap-4 featured-container " style={{ marginTop: '5rem' }}>
                    <div className="md:flex-1  p-6 shadow-lg rounded-lg lg:text-end text-center ">
                        <h3 className='text-3xl text-[#8b7d6b] font-bold'>Featured Projects</h3>
                    </div>

                    <div className="md:flex-2 flex-1 text-1xl shadow-lg rounded-lg text-black" style={{ padding: '0px 3rem' }}>
                    ...
                    <div className="flex-1  p-6 shadow-lg rounded-lg lg:text-end text-center">
