        ...
        <>
            <section className='banner-container'>
                ...
                <div className='overlay-section'>
                    <h1 className='text-5xl lg:text-9xl w-[70%] text-white' data-aos='fade-right'>Welcome to Urban Crescent</h1>
                    <p className='w-[70%] uppercase tracking-widest' data-aos='fade-left' style={{ padding: '1.2rem 0px' }}>We design like we own it</p>
                    <button className='btn btn-outline button' data-aos='fade-up' style={{ padding: '1.5rem 1rem', fontSize: '1.2rem', color: 'white' }}>Explore Our Design</button>
