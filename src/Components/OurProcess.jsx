    ...
    return (
        <>
            <section className="section-center">
                <SubHeading text='Over 200,000 sq ft of premium commercial and residential spaces in execution globally' />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 featured-container">
                    {Process.map((item) => {
                        return (
                            ...
                            <div className="text-black shadow-lg text-center h-[auto] rounded-sm  divide-x-3 divide-dashed md:divide-amber-800" style={{ padding: '1rem' }} key={item.id}>
