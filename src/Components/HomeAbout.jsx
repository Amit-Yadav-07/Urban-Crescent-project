        ...
        <div className='section-center'>
            ...
            <div className="flex flex-col lg:flex-row gap-5">
                ...
                <div className="flex-1 w-[100%]">
                    ...
                    <div className="bg-[url('https://www.essajeesatelier.com/wp-content/uploads/2023/07/Sarah-Sham.jpg')] w-[100%] min-h-[700px] bg-no-repeat bg-center h-auto rounded-md" data-aos='fade-left'></div>
                </div>
            </div>
        </div>
    )
