...
const About = () => {
    return (
        <>
            ...
            <section className="section-center">
                <div className="flex lg:flex-row flex-col gap-5" style={{ margin: '3rem 0px' }}>
                    ...
                    <div className="flex-2 text-black">
                        <p data-aos='fade-left'>Essajees Atelier is a global interior design company offering end-to-end services in the realm of luxury interiors.</p>
                        <br />
                        <p style={{ marginBottom: '3rem' }} data-aos='fade-left'>Started in 2014, Essajees Atelier has completed over 60 interior design projects across the country, with over 200,000 sqft of commercial and residential spaces currently under construction. We have completed projects across 11 cities such as Mumbai, Surat, Goa, Bangalore, Hyderabad, Kolkata, Dubai, Pune, Chennai, Malavli, Nashik etc.</p>
                        {/* experience */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {experience.map((items) => {
                                return (
                                    <div className="text-white flex flex-col justify-between w-[100%]" key={items.id} style={{ padding: '1rem' }}>
                                        <SubHeading text={items.heading} style={'0rem auto 2rem auto'} />
            ...
            <div className="flex flex-col lg:flex-row section-center gap-5" style={{ marginBottom: '3rem' }}>
                <div className="flex-1">
