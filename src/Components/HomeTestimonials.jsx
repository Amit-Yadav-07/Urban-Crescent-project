...
const HomeTestimonials = () => {
    ...
    return (
        <div className='section-center'>
            ...
            <div className="md:w-[100%] bg-gray-100 rounded-xl" data-aos='fade-right' style={{ margin: '0px auto 3rem auto', padding: "2rem 0px" }}>
                <Slider {...settings}>
                    {Testimonials.map((items) => {
                        return (
                            <div className='grid place-content-center place-items-center w-[100%] min-h-[300px] max-[auto] rounded-sm' key={items.id}>
                                ...
                                <p className='text-black text-7xl md:w-[65%] w-[90%] text-center' style={{ margin: '0px auto' }}>{items.message}</p>
                            </div>
                        )
                    })}
                </Slider>
